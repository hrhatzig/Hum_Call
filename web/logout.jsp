    ...
    <body>
        ...
        <div id="menu-container">
            ...
            <div id="menu-1" class="homepage home-section container">
                <center><p class="animated fadeInRight">
                    <span class="blue">You are successfully logged out!</span>
                </p></center>
            ...
            <div id="menu-3" class="content login-section container">
                <c:import url="login.jsp"></c:import>
            </div>
            
            <div id="menu-4" class="content register-section container">
